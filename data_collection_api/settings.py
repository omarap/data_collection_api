"""
Django settings for data_collection_api project.
...
SECRET_KEY = 'django-insecure-2q9hj6+gfzfppy37octi641db^agj%a972a7m(nh)snyg0@gl#'
...
ROOT_URLCONF = 'data_collection_api.urls'
...
WSGI_APPLICATION = 'data_collection_api.wsgi.application'
